...
namespace Pertemuan4_XML
{
    public partial class Form1 : Form
    {
        ...
        {
            int n = dgv1.Rows.Add();
            dgv1.Rows[0].Cells[0].Value = txtKode.Text;
            dgv1.Rows[0].Cells[1].Value = txtJudul.Text;
            dgv1.Rows[0].Cells[2].Value = txtPenerbit.Text;
            bersihBuku();
        }
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            foreach(DataGridViewRow baris in dgv1.Rows)
            {
                ...
                row["Kode"] = baris.Cells[0].Value;
                row["Judul"] = baris.Cells[1].Value;
                row["Penerbit"] = baris.Cells[2].Value;
                ds.Tables["Buku"].Rows.Add(row1);
            }
            ds.WriteXml("C:\\Katalog.xml");
